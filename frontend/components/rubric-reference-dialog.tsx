...
const scoringBands: ScoringBandItem[] = [
  {
    band: "Excellent",
    range: "80–100%",
    scoreRange: "Band 4 · 87.5%",
    dotColor: "bg-brand-600 dark:bg-brand-400",
    containerClass:
      "border-brand-300 dark:border-brand-800 bg-brand-50/70 dark:bg-brand-950/40 hover:border-brand-400",
    badgeClass: "text-brand-950 dark:text-brand-200 font-semibold",
    desc: "Exemplary cursive discipline with fluid loop closures, uniform 60°–68° forward slant, and consistent baseline adherence.",
    pedagogyTip: "Ready for advanced multi-paragraph composition and personal cursive fluency.",
  },
  {
    band: "Satisfactory",
    range: "60–79%",
    scoreRange: "Band 3 · 62.5%",
    dotColor: "bg-[#7c9b6e]",
    containerClass:
      "border-[#7c9b6e]/30 bg-[#7c9b6e]/10 dark:bg-[#7c9b6e]/15 hover:border-[#7c9b6e]/50",
    badgeClass: "text-[#2c4e22] dark:text-[#c4deba] font-semibold",
    desc: "Strong cursive legibility with minor spacing or slant variations on complex letter joins (b, k, f, z).",
    pedagogyTip: "Reinforce tricky ascender loop transitions and uniform 1-letter character spacing.",
  },
  {
    band: "Developing",
    range: "40–59%",
    scoreRange: "Band 2 · 37.5%",
    dotColor: "bg-[#c9a227]",
    containerClass:
      "border-[#c9a227]/30 bg-[#c9a227]/10 dark:bg-[#c9a227]/15 hover:border-[#c9a227]/50",
    badgeClass: "text-[#6e4e00] dark:text-[#fae59a] font-semibold",
    desc: "Recognizable cursive structure with noticeable letterform irregularities, midline drift, or fluctuating slant.",
    pedagogyTip: "Targeted practice on resting letters on the bottom baseline and keeping lowercase x-height at the midline.",
  },
  {
    band: "Needs Improvement",
    range: "0–39%",
    scoreRange: "Band 1 · 12.5%",
    dotColor: "bg-[#b6754a]",
    containerClass:
      "border-[#b6754a]/30 bg-[#b6754a]/10 dark:bg-[#b6754a]/15 hover:border-[#b6754a]/50",
    badgeClass: "text-[#733512] dark:text-[#f3c8aa] font-semibold",
    desc: "Frequent print-cursive hybrid strokes, disconnected joins, erratic slant angles, or significant baseline drift.",
    pedagogyTip: "Return to stroke foundational drills: undercurves, downcurves, and complete loop closures.",
  },
];
