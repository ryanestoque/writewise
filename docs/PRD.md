...
- **Document type:** Internal engineering PRD (build guide for the dev team, companion to ARCHITECTURE.md, DESIGN.md, CV_PIPELINE.md, ML_PIPELINE.md, DATABASE.md, API_SPEC.md)
